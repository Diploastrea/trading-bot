...
public class IBClient {
   ...
   * handshake is complete adn reader thread signals TWS API is ready. If the connection times out,
  ...
  private void startReaderThread() {
    ...
    reader.start();
    Thread.ofPlatform().name("reader").start(() -> {
      while (client.isConnected() && readerThreadRunning.get()) {
