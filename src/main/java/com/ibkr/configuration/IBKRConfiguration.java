...
public class IBKRConfiguration {
   ...
   * circular dependency chain (IBClient -> EClientSocket -> EWrapper -> IBClient). This allows the
   * Spring ApplicationContext to initialise successfully by providing a proxy for the wrapper
   * during the initial bean construction.
   *
